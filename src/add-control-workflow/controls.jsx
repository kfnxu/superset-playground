...
export const controls = {
  ...
  charttype: {
    ...
    mapStateToProps: (state) => {
      return {
         choices: (state.datasource) ? state.inj_form_data.charttype : [],
      }
    },
  ...
  viscontainer: {
    ...
    mapStateToProps: (state) => {
      return {
         choices: (state.datasource) ? state.inj_form_data.viscontainer : [],
      }
    },
    description: 'Visualization container to display',
  },
  ...
  vistype_select: {
    ...
    mapStateToProps: (state) => {
      return {
         choices: (state.datasource) ? state.inj_form_data.vistype : [],
      }
    },
    description: 'Visualization type to display',
  },
  ...
  measure: {
    ...
    default: null, 
    mapStateToProps: (state) => {
      console.log('controls.jsx measure', state);
      return { 
         choices: (state.datasource) ? state.inj_form_data.sf_measure : [], 
      }
    },
    description: 'One or many measure to display',
  },
  ...
  cause: {
    ...
    default: null, 
    mapStateToProps: state => ({
      choices: (state.datasource) ? state.inj_form_data.sf_cause : [],
    }),
    description: 'One or many cause to display',
  },
  ...
  risk: {
    ...
    default: null, 
    mapStateToProps: state => ({
      choices: (state.datasource) ? state.inj_form_data.sf_risk : [],
    }),
    description: 'One or many risk to display',
  },
  ...
  location: {
    ...
    default: null, 
    mapStateToProps: state => ({
      choices: (state.datasource) ? state.inj_form_data.sf_location : [],
    }),
    description: 'One or many location to display',
  },
  ...
  age_select: {
    ...
    default: null, 
    mapStateToProps: state => ({
      choices: (state.datasource) ? state.inj_form_data.sf_age_select : [],
    }),
    description: 'One or many age-group to display',
  },
  ...
  sex_select: {
    ...
    default: 1, 
    mapStateToProps: state => ({
      choices: (state.datasource) ? state.inj_form_data.sf_sex : [],
    }),
    description: 'One or many sex to display',
  },
  ...
  unit_select: {
    ...
    default: null, 
    mapStateToProps: state => ({
      choices: (state.datasource) ? state.inj_form_data.sf_unit : [],
    }),
    description: 'One or many unit to display',
  },
  ...
  viscontainer_group: {
    ...
    mapStateToProps: (state) => {
      return {
         choices: {
                    //data: (state.datasource) ? state.inj_form_data.viscontainer : [],
                    data: state.inj_form_data.viscontainer,
                    columns: 3,
                  },
      }
    },
    description: 'Visualization mode to display',
  },
  ...
  model_group: {
    ...
    default: null,
    mapStateToProps: state => ({
      choices: (state.datasource) ? state.inj_form_data.sf_model_group : [],
    }),
    description: 'One or many model to display',
  },
  ...
  year_group: {
    ...
    label: 'Year',
    default: ['2006','2020'],
    //choices:[['1996','1996'], ['1997','1997'],['1998','1998'],['1999','1999'],['2000','2000']], 
    mapStateToProps: state => ({
      choices: (state.datasource) ? state.inj_form_data.sf_year_group : [],
    }),
  ...
  rate_of_change_switch: {
    ...
    description: 'Rate of change selection',
  },

  ////to make GBD-like UI chartype selection works
  //charttype_group: {
  viz_type: {
    type: 'IntegrationOfficeVizTypeControl',
    multi: true,
    label: 'Chart Type Group',
    default: 'table',
    mapStateToProps: state => ({
      choices: {
                 //data:(state.datasource) ? state.inj_form_data.charttype : [],
                 data:state.inj_form_data.charttype,
                 columns: 3,
               },
    }),
  ...
  vistype_group: {
    ...
    mapStateToProps: state => ({
      choices: {
                 //data:(state.datasource) ? state.inj_form_data.vistype : [],
                 data:state.inj_form_data.vistype,
                 columns: 2,
               },
    }),
    description: 'visualization type to display',
  ...
  sex_group: {
    ...
    mapStateToProps: state => ({
      choices: {
                 //data: (state.datasource) ? state.inj_form_data.sf_sex_group : [],
                 data: state.inj_form_data.sex ,
                 columns: 3,
               },
    }),
    description: 'sex selection',
  },
  ...
  unit_group: {
    ...
    mapStateToProps: state => ({
      choices: {
                 //data: (state.datasource) ? state.inj_form_data.unit : [],
                 data: state.inj_form_data.unit ,
                 columns: 3,
               },
    }),
    description: 'One or many unit to display',
  ...
  age_group: {
    ...
    mapStateToProps: state => ({
      choices: {
                 //data: (state.datasource) ? state.inj_form_data.age_group : [],
                 data: state.inj_form_data.age_group,
                 columns: 3, 
               },
    }),
    description: 'One or many age-group to display',
